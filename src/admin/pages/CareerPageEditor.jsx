            ...
            <form onSubmit={handleJobSave} className="p-6 space-y-4">
              ...
              <div className="flex justify-end gap-2 pt-2">
                <button type="button" onClick={closeJobForm}
                  className="px-4 py-2 text-sm font-medium text-admin-600 hover:bg-admin-100 rounded-lg transition-colors cursor-pointer">
                  Cancel
                </button>
                <button type="submit" disabled={jobSaving}
                  className="px-4 py-2 text-sm font-medium text-white bg-admin-600 hover:bg-admin-700 rounded-lg transition-colors disabled:opacity-50 cursor-pointer">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2 pt-5">
                  <input type="checkbox" id="cat_is_active" name="is_active" checked={categoryForm.is_active} onChange={handleCategoryChange}
                    className="w-4 h-4 rounded border-admin-200 text-admin-600 focus:ring-admin-500/20" />
                  <label htmlFor="cat_is_active" className="text-sm text-admin-600">Active</label>
                </div>
              </div>
              <div className="flex justify-end gap-2 pt-2">
