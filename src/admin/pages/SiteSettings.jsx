  ...
  return (
    <PageShell title="Site Settings" subtitle="Contact info, social links, and logo">
      ...
      <form onSubmit={handleSave} className="bg-white rounded-lg border border-slate-200 p-6 space-y-6">
        ...
        <div className="border-t border-neutral-100 pt-6">
          <h3 className="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
            <FiGlobe className="w-4 h-4 text-indigo-600" /> Social Links
          </h3>
          <div className="grid sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={s.key}>
                <label className="block text-xs font-semibold text-slate-700 mb-1.5 uppercase tracking-wider">{s.label}</label>
        ...
        <div className="border-t border-neutral-100 pt-6">
          <h3 className="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
            <FiMapPin className="w-4 h-4 text-indigo-600" /> Address
          </h3>
          <div>
        ...
        <div className="border-t border-neutral-100 pt-6">
          <h3 className="text-sm font-semibold text-slate-700 mb-4 flex items-center gap-2">
            <FiClock className="w-4 h-4 text-indigo-600" /> Working Hours
          </h3>
          <div className="grid sm:grid-cols-2 gap-4">
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1.5 uppercase tracking-wider">Weekdays</label>
            ...
            <div>
              <label className="block text-xs font-semibold text-slate-700 mb-1.5 uppercase tracking-wider">Saturday</label>
