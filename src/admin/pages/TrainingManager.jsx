  ...
  const columns = [
    {
      header: 'Title',
      cell: (row) => (
        <Link to={`/admin/training/${row.id}`} className="text-sm font-medium text-neutral-900 hover:text-indigo-600 transition-colors">
          {row.title || 'Untitled'}
        </Link>
      ),
    },
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex items-center justify-end gap-1">
          {row.slug && <Link to={`/training/${row.slug}`} target="_blank" className="p-1.5 text-neutral-400 hover:text-indigo-600 rounded-md hover:bg-indigo-50 transition-colors" title="Preview"><FiExternalLink className="w-4 h-4" /></Link>}
          <Link to={`/admin/training/${row.id}`} className="p-1.5 text-neutral-400 hover:text-indigo-600 rounded-md hover:bg-indigo-50 transition-colors" title="Edit"><FiEdit2 className="w-4 h-4" /></Link>
