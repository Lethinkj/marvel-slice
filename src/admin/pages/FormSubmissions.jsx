  ...
  return (
    <div className="max-w-7xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl font-bold text-dark-navy">Form Submissions</h1>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="pt-2">
                <a href={`mailto:${selected.email}?subject=Marvel%20Slice%20-%20Your%20Demo%20Class%20Inquiry&body=Hi%20${encodeURIComponent(selected.full_name)}%2C%0A%0AThank%20you%20for%20your%20interest%20in%20Marvel%20Slice.%20We%20will%20get%20back%20to%20you%20shortly.%0A%0ARegards%2C%0AMarvel%20Slice%20Team`}
                  className="inline-flex items-center gap-2 px-4 py-2 bg-brand-accent text-white rounded-lg text-sm font-medium hover:opacity-90 transition-all shadow-sm">
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
        <h2 className="text-lg font-bold text-dark-navy mb-2">Export CSV</h2>
        <p className="text-sm text-gray-500 mb-4">Export {allData.length} submission{allData.length !== 1 ? 's' : ''} to CSV</p>
        <div className="flex gap-2 justify-end">
          <button onClick={onClose} className="px-4 py-2 border border-gray-300 rounded-lg text-sm text-gray-600 hover:bg-gray-50 transition-colors">Cancel</button>
          <button onClick={doExport} disabled={loading}
            className="flex items-center gap-2 px-4 py-2 bg-brand-accent text-white rounded-lg text-sm font-medium hover:opacity-90 transition-all disabled:opacity-50">
