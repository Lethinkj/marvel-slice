...
import {
  FiPlus, FiTrash2, FiSearch, FiFilter, FiPackage,
} from 'react-icons/fi';
    ...
    },
    {
      ...
      cell: (row) => (
        <div className="flex items-center justify-end gap-1">
          <Link to={`/admin/services/${row.id}`} className="px-2.5 py-1 text-xs font-medium text-amber-600 bg-amber-50 hover:bg-amber-100 rounded-md transition-colors">Edit</Link>
