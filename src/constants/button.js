...
export const BUTTON_VARIANTS = {
  ...
  'link-add': 'text-brand-accent font-medium hover:text-brand-blue inline-flex items-center gap-1.5 transition-all',
  pill: 'bg-gray-100 text-text-gray font-medium hover:bg-gray-200 transition-all',
  'pill-active': 'bg-brand-accent text-white font-medium shadow-sm transition-all',
