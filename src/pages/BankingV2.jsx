...
import { FiCheckCircle, FiArrowRight, FiTarget, FiX, FiLoader, FiSearch, FiChevronDown } from 'react-icons/fi';
...
export default function BankingV2() {
  ...
  async function handleApplySubmit(e) {
    ...
    trackRegister('BankingV2');
    trackFormSubmit('BankingV2');
                  ...
                  {affairsOpen && (
                    ...
                    >
                      <Link
                        ...
                        className="block px-4 py-2 text-xs sm:text-sm font-medium text-slate-700 hover:bg-blue-50/60 hover:text-brand-blue transition-colors"
                      >
                        Current Affairs
                      </Link>
                      <Link
              ...
              <div className="p-5 sm:p-6 bg-[#F8FAFD]">
                {isSubmitted ? (
                  <div className="text-center py-6 space-y-4">
                    <div className="w-14 h-14 bg-blue-50 text-brand-blue rounded-full flex items-center justify-center mx-auto border border-blue-200 shadow-xs">
